...
for i,experiment in experiments do
  Khi, Fhi, Klo, Flo, mesh = form_problem(meshfun, experiment[2], experiment[3],1)
  x1,r1,it1, x2,r2,it2, x3,r3,it3 = solve_problem(Khi, Fhi, Klo, Flo,mesh) 
  mesh:delete()
