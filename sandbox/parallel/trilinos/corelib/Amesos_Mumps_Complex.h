...
#ifndef AMESOS_MUMPS_COMPLEX_H
#define AMESOS_MUMPS_COMPLEX_H
...
//! Amesos_Mumps:  An object-oriented wrapper for the complex
//!                double precision version of MUMPS.
/*!  Amesos_Mumps is an interface to the the complex double precision version of
...
class Amesos_Mumps_Complex: public Amesos_BaseSolver_Complex,
                    private Amesos_Time,
...
public:
  ...
  */
  Amesos_Mumps_Complex(const Epetra_LinearProblem_Complex& LinearProblem);

  //! Amesos_Mumps Destructor.
  /*! Deletes an Amesos_Mumps object.
  */
  ~Amesos_Mumps_Complex(void);
  //@}
  ...
  */
  int SetPrecscaling(dcomplex * ColSca, dcomplex * RowSca )
  {
    ColSca_ = ColSca;
    RowSca_ = RowSca;
    return 0;
  ...
  */
  int SetRowScaling(dcomplex* RowSca )
  {
    RowSca_ = RowSca;
    return 0;
  }
  ...
  */
  int SetColScaling(dcomplex* ColSca )
  {
    ColSca_ = ColSca;
    return 0;
  }
...
protected:
  ...
  Epetra_RowMatrix& Matrix_i();

  const Epetra_RowMatrix& Matrix() const;
  const Epetra_RowMatrix& Matrix_i() const;
  ...
  Epetra_RowMatrix& RedistrMatrix_i(const bool ImportMatrix = false);
  ...
  RefCountPtr<Epetra_CrsMatrix_Complex> CrsSchurComplement_;
  ...
  RefCountPtr<Epetra_CrsMatrix> RedistrMatrix_i_;
  ...
  map<int, int> ICNTL;
  map<int, double> CNTL;
};  // class Amesos_Mumps_Complex

#endif /* AMESOS_MUMPS_COMPLEX_H */
