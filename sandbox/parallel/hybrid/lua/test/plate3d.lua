...
--pelt = make_material_e(post_material, '3d')
--delt = make_material_e(disk_material, '3d')
etype= make_material_e(disk_material, '3d');
...
hpost= hpost or 5e-6      -- Height of post layer
