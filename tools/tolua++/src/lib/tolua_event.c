...
** TeCGraf/PUC-Rio
** Apr 2003
** $Id: tolua_event.c,v 1.2 2006/06/15 19:47:48 dbindel Exp $
*/
...
/* -- DSB --
 * This code causes a strange recursive loop in the following case:
 *   class Parent {};
 *   class Child : public Parent {};
 *   Child.foo = 10
 * According to W. Celes, removing this will probably break the handling
 * of static members under inheritance.  That's okay with me.
 * -- DSB --
