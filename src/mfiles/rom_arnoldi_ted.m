% [Mk,Dk,Kk,Lk,Bk,Vk] = rom_arnoldi_ted(M,D,K,L,B,nm, kk, w0, opt)
%
...
function [Mk,Dk,Kk,Lk,Bk,Vk] = rom_arnoldi_ted(M,D,K,L,B,nm, kk, w0, opt)
...
elseif  realbasis & ~structurep
  VV = [real(V(:,1:kk+1)), imag(V(:,1:kk+1))];
  [U1,S1,V1] = svd(VV,0);
  S1 = diag(S1);
