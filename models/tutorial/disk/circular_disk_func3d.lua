...
function mesh_post_interface1(rix,riy,ro,zt,nd,angi)
...
function mesh_post_interface(xo,yo,r1,rt1,zt,nd,angi)
    ...
    mesh_post_interface1(ax2,ay2,rt1,zt,nd,angi)
    ...
    mesh_post_interface1(ax2,ay2,rt1,zt,nd,angi+pi/4)
