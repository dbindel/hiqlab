...
belt  = mesh:PMLElastic2d_planestrain(beam_material, wafer, angle)
...
bc_func1,st_func1 = pml_blocks2d({x1,x1},{y1,y2},2,anW,anH,pmlD,f0,
                                  etype,order,dense_x,dense_y)
bc_func2,st_func1 = pml_blocks2d({x4,x4},{y1,y2},2,anW,anH,pmlD,f0,
                                  etype,order,dense_x,dense_y)
