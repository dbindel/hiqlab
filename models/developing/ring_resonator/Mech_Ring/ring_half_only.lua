...
-- Construct half ring
if which_half=='W' then
    ind1 = 2
    ind2 = 3
    symmetric_bc = symmetric_x_bc
elseif which_half=='E' then
    ind1 = 1
    ind2 = 4
    symmetric_bc = symmetric_x_bc
elseif which_half=='S' then
    ind1 = 3
    ind2 = 4
    symmetric_bc = symmetric_y_bc
elseif which_half=='N' then
    ind1 = 1
    ind2 = 2
    symmetric_bc = symmetric_y_bc
else
...
-- Construct ring
quad_ring2d(ind1, Ri, Rt, Nt, Nw, Nw, Bl, Bl, Bw, Bw, etype, order, dense)
quad_ring2d(ind2, Ri, Rt, Nt, Nw, Nw, Bl, Bl, Bw, Bw, etype, order, dense)

-- Set boundary condition
mesh:set_bc{bc_func,symmetric_bc}
