...
-- Construct pmlblocks
--bc_func1,st_func1 = pml_blocks2d({-Bl-Rm*cos(Al),-Bl-Rm*cos(Al)},{ Bw/2,0,-Bw/2},2,Pw,Ph,Pd,f0,
--                                     etype,order,dense,dense)
--bc_func2,st_func2 = pml_blocks2d({ Rm*cos(Al)+Bl, Rm*cos(Al)+Bl},{-Bw/2,0,Bw/2},2,Pw,Ph,Pd,f0,
--                                     etype,order,densex,densey)

--bc_pml1,s_pml1 =  pml_blocks2d('E',{-Bl-Rm*cos(Al)},
--                                   {-Bw/2,0,Bw/2},2,Pw,Ph,Pd,f0,etype,order,dense)
--bc_pml2,s_pml2 =  pml_blocks2d('W',{ Rm*cos(Al)+Bl },
--                                   {-Bw/2,0,Bw/2},2,Pw,Ph,Pd,f0,etype,order,dense)

-- Set stretch function
--etype:set_stretch{st_func1,st_func2}
